...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Activv Connect — Find your next game" },
      { name: "description", content: "Skill-matched sports matchmaking for athletes across the US." },
      { name: "author", content: "Activv Connect" },
      { property: "og:title", content: "Activv Connect" },
      { property: "og:description", content: "Skill-matched sports matchmaking for athletes across the US." },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('activv.theme');var d=document.documentElement;if(t==='light'){d.classList.remove('dark');d.classList.add('light');}else{d.classList.add('dark');d.classList.remove('light');}}catch(e){}})();`,
          }}
        />
      </head>
      <body>
